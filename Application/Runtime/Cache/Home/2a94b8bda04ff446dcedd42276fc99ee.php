...
<div class="row">
    ...
    <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2  mainIco" style="background-color: rgb(178,26,65)">
            <div class="mainIco_wrap">
    ...
    <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 mainIco" style="background-color: rgb(210,71,38)">
        <div class="mainIco_wrap">
    ...
    <div class="col-xs-3 col-sm-4 col-md-3 col-lg-2 mainIco" style="background-color: rgb(255,190,0)">
        <div class="mainIco_wrap">
    ...
    <div class="col-xs-3 col-sm-4 col-md-3 col-lg-2 mainIco" style="background-color: rgb(81,51,171)">
        <div class="mainIco_wrap">
    ...
    <div class="col-xs-2 col-sm-4 col-md-3 col-lg-2 mainIco" style="background-color: rgb(0,138,0)">
        <div class="mainIco_wrap">
    ...
    <div class="col-xs-3 col-sm-4 col-md-3 col-lg-2 mainIco" style="background-color: rgb(159,0,166)">
        <div class="mainIco_wrap">
    ...
    <div class="row">
        ...
        <div   class="col-xs-7 col-sm-8 col-md-9 col-lg-9 ">
            <div id="windows_btn_wrap">
                ...
                <button type="button"  class="btn btn-primary btn-1g windows_btn" windowsName="mucic">
